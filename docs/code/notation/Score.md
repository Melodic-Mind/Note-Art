...
<dt><a href="#addNote">addNote(note, [duration], position, measureIndex, [voiceIndex])</a> ⇒ <code>boolean</code></dt>
...
## addNote(note, [duration], position, measureIndex, [voiceIndex]) ⇒ <code>boolean</code>
